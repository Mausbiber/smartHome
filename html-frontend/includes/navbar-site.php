<div id="sidebar-wrapper">
    <div class="list-group">
        <a href="#" class="list-group-item"><nobr><?php echo htmlspecialchars($lang['dashboard']); ?></nobr></a>
        ...
        <div class="collapse" id="settings">
            ...
            <a href="#" class="list-group-item list-group-item-sub"><nobr><?php echo htmlspecialchars($lang['sensors']); ?></nobr></a>
        </div>
    </div>
</div>
